...
const CaseStudies = async ({
  ...
  return (
    ...
    >
      <h2 className="max-w-2xl text-5xl font-medium text-center text-balance md:text-7xl">
        ...
        {caseStudies.map(
          (caseStudy, index) =>
            caseStudy && (
              <div
                key={caseStudy.id}
                className="relative grid gap-4 transition-opacity duration-300 opacity-85 hover:cursor-pointer hover:opacity-100 md:grid-cols-2 md:gap-8 lg:grid-cols-3"
              >
                <div className="flex flex-col justify-center col-span-1 gap-4">
